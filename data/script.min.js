...
function Remainings(x) {
var my_btn_id = "#modal1";
	var n = new Date();
	var c = new Date();
	n.setTime(c.getTime() + 1000 * x[8].childNodes[0].nodeValue);
	var distance = n - c;
	if (distance <= 0) {
...
function PumpUpdate(x) {
	document.getElementById("wave_selection").value=x[0].childNodes[0].nodeValue
}
