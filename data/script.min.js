function initArduinoIO(){
	...
	stateGroups = Array(docGroups.lenght);
	...
	stateCountdown=Array(docCountdowns.length),
	...
	t.onreadystatechange=
		function(){
					4==this.readyState&&200==this.status&&null!=this.responseXML&&(AnalogXMLupdate(this.responseXML.getElementsByTagName("analog")),
																					...
																					CheckBoxUpdate(this.responseXML.getElementsByTagName("CheckBox")))
									};
	var n="";
	if(gotState){
//	if(true){
...
//console.log(docSockets[i].checked?"SOC"+i+"=1&":"SOC"+i+"=0&"),
		...
		for(i=0;i<docGroups.length;i++)
			stateGroups[i]!=$(docGroups[i])[0].value&&(stateGroups[i]=$(docGroups[i])[0].value,n+="SOCG"+i+"="+$(docGroups[i])[0].value+"&")
	}
//	console.log(n),
